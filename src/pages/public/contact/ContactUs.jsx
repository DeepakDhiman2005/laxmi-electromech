...
const ContactUs = () => {
    ...
    // Contact Cards Data
    const contactCards = [
        { icon: <Map />, title: 'Visit Us Anytime', details: ['A-82', 'Noida Sector 63'] },
        { icon: <Drafts />, title: 'Send an Email', details: ['support@example.com', 'abc@example.com'] },
        { icon: <Headset />, title: 'Contact Us', details: ['+012 (345) 78967', '+9865322200'] },
    ];
