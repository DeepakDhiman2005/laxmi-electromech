        ...
        <section className="py-3 px-4 sm:px-8 grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="flex justify-start items-center gap-x-5 px-6 py-5 bg-[#3c3c3c] text-white group transition-transform duration-500">
                ...
                <div className="flex flex-col justify-start items-start">
                    <h2 className="font-bold text-[18px] text-white">About Us</h2>
                    <p className=" text-white text-[12px]">Laxmi Electromech Pvt. Ltd. (LEPL) is a CPRI-approved and trusted name in the field of electrical and automation solutions.</p>
                </div>
            ...
            <div className="flex items-center gap-x-5 group px-6 py-5 bg-gray-200 text-black transition-transform duration-500">
                ...
                <div className="flex flex-col">
                    <h2 className="font-bold text-lg text-black">Creative Solutions</h2>
                    <p className="text-sm text-[13px]">Driving innovation with smart, efficient, and forward-thinking solutions.</p>
                </div>
            </div>
            ...
            <div className="flex justify-start items-center gap-x-5 px-6 py-5 bg-gray-100 group transition-transform duration-500">
                ...
                />
                <div className="flex flex-col justify-start items-start">
                    <h2 className="font-bold text-[20px] text-black">Tagline Ideas</h2>
                    <p className="text-[13px]">Empowering technology to transform industries and enhance everyday life.</p>
                </div>
            </div>
        </section>
    );
