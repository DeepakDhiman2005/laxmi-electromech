...
const ProductCategoriesSection = () => {
    ...
    return (
        <Box sx={{ py: 5, px: { xs: 2, sm: 5, md: 8 }, overflow: 'hidden' }}>
            ...
            <Grid container spacing={3} justifyContent="center">
                {productCategories.map((category, index) => (
                    <Grid item xs={12} sm={6} md={4} key={index} sx={{
                        ...
                        <Card sx={{ textAlign: "center", p: 2, boxShadow: 3, background: '#f1f2f9' }} data-aos={index === 0 ? "fade-right" : index === 1 ? "fade-up" : "fade-left"}>
                            <CardContent>
                                {category.icon}
