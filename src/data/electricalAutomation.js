const electricalAutomation = [
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                PLC hardware with electrical components to ensure precise automation, reducing manual intervention and enhancing 
                productivity.
            </p>
            ...
            <div style="display: flex; justify-content: start; margin: 10px 0;">
                <img src="/images/laxmi-services/plc-control-panel-3.jpg" style="width: 50%; border-radius: 8px;" alt="PLC Control Panel" />
            </div>
        `
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                With a user-friendly touchscreen interface, HMI panels replace traditional buttons and switches, enhancing efficiency and reducing operational complexity.
            </p>
            <div style="display: flex; justify-content: center; margin: 2px 0;">
                <img src="https://5.imimg.com/data5/BS/RA/MY-2342627/hmi-touch-panel-500x500-500x500.jpg" style="width: 40%; border-radius: 8px;" alt="HMI Touch Panel" />
            </div>
            <p style="font-size: 18px; margin: 2px 0;">
                <b>Our HMI Touch Panels</b> feature high-resolution displays, multi-touch support, and customizable interfaces for various industrial applications. 
                These panels integrate seamlessly with PLCs and SCADA systems, offering real-time diagnostics, alarm management, and process control. 
                Their rugged design ensures durability in harsh industrial environments.
            </p>
            <p style="font-size: 18px; margin: 2px 0;">
            ...
            <div style="display: flex; justify-content: center; margin: 2px 0;">
                <img src="https://www.esa-automation.com/wp-content/uploads/2024/11/Soluzioni-Industrial-HMI-con-Touch-Panel-di-ESA_Automation-1170x795.jpg" style="width: 40%; border-radius: 8px;" alt="HMI Touch Panel" />
            </div>
        `
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                This advanced system is essential in industries requiring precise monitoring, automation, and efficiency.
            </p>
            <div style="display: flex; justify-content: start; margin: 10px 0;">
                <img src="/images/laxmi-services/scada-control.webp" style="width: 40%; border-radius: 8px;" alt="SCADA System" />
            </div>
            <p style="font-size: 18px; margin: 2px 0;">
                <b>Our SCADA Solutions</b> offer a powerful and scalable platform to enhance industrial automation and decision-making. 
                With real-time data acquisition, alarm management, and remote access capabilities, our SCADA systems ensure seamless communication between field devices and operators. 
                These systems integrate seamlessly with HMI panels and PLCs, providing a complete automation solution.
            </p>
            <p style="font-size: 18px; margin: 2px 0;">
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                With cutting-edge visualization tools and seamless integration capabilities, our SCADA systems help businesses achieve smarter automation and improved operational control.
            </p>
        `
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                We offer both conventional and intelligent MCCs to cater to the evolving needs of industrial automation.
            </p>
        `
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                and optimizing performance in industrial and commercial applications.
            </p>
            <div style="display: flex; justify-content: center; margin: 2px 0;">
                <img src="/images/laxmi-services/vdf-drive-panel.jpg" style="width: 40%; border-radius: 8px;" alt="VFD Drive" />
            </div>
            <p style="font-size: 18px; margin: 2px 0;">
                Our VFD drives are designed to provide precise motor control, enabling seamless acceleration and deceleration based on process demands. 
                These drives contribute to significant energy savings by allowing motors to operate at optimal speeds instead of running at full capacity. 
                With built-in protection features such as overload protection, phase loss detection, and fault diagnostics, our VFDs ensure maximum reliability 
                and longevity of motor systems.
            </p>
            <p style="font-size: 18px; margin: 2px 0;">
                VFD drives are widely used in industries such as HVAC, water treatment, conveyor systems, and manufacturing processes where precise motor 
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                motor types, ensuring adaptability to various operational requirements.
            </p>
        `
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                Unlike traditional direct-on-line starters, which can cause high starting currents and mechanical shocks, a Soft Starter ensures a smooth 
                and efficient startup process, significantly reducing wear and tear on motor components.
            </p>
            <p style="font-size: 18px; margin: 2px 0;">
                Soft Starters are widely used in industries such as HVAC, water pumping stations, conveyor systems, and heavy machinery where reducing electrical 
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                between motor protection and efficiency.
            </p>
        `
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                circuit breakers, switches, relays, and other electrical devices to ensure seamless operation and protection of electrical systems.
            </p>
            <div style="display: flex; justify-content: center; margin: 10px 0;">
                <img src="/images/laxmi-services/electrical-control-panel.jpg" style="width: 40%; border-radius: 8px;" alt="Electrical Control Panel" />
            </div>
            <p style="font-size: 18px; margin: 2px 0;">
                Electrical Control Panels are widely used in industrial automation, commercial buildings, and residential applications. 
                They help in controlling motors, HVAC systems, lighting, and other electrical loads efficiently. The integration of modern 
                technologies, such as PLCs (Programmable Logic Controllers) and HMIs (Human-Machine Interfaces), further enhances the 
                functionality of these panels by enabling remote monitoring and automation.
            </p>
            <p style="font-size: 18px; margin: 2px 0;">
                Our Electrical Control Panels are designed with high-quality components to ensure durability, efficiency, and safety. 
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                operational efficiency while ensuring compliance with electrical safety standards.
            </p>
        `
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                <b>Programmable Logic Controllers (PLC)</b>, <b>Human-Machine Interfaces (HMI)</b>, and <b>Supervisory Control and Data Acquisition (SCADA)</b>, 
                to provide seamless control and monitoring of automated systems.
            </p>
            <div style="display: flex; justify-content: center; margin: 10px 0;">
                <img src="/images/laxmi-services/automation-control-panel.jpg" style="width: 40%; border-radius: 8px;" alt="Automation Control Panel" />
            </div>
            <p style="font-size: 18px; margin: 2px 0;">
                Automation Control Panels enhance operational efficiency by reducing manual intervention, minimizing errors, and ensuring 
                smooth workflow in manufacturing, process industries, and power distribution systems. These panels provide real-time data 
                monitoring, fault detection, and remote control capabilities, making them an indispensable part of modern industrial operations.
            </p>
            <p style="font-size: 18px; margin: 2px 0;">
                Our Automation Control Panels are built with high-quality electrical components and advanced software configurations to 
    ...
    },
    {
        ...
        description: `
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                and controllers, reducing wiring complexity and ensuring efficient data transmission. These modules provide a flexible 
                and scalable solution for integrating distributed control systems with <b>Programmable Logic Controllers (PLC)</b>, 
                <b>Supervisory Control and Data Acquisition (SCADA)</b>, and other automation devices.
            </p>
            <div style="display: flex; justify-content: center; margin: 2px 0;">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS95EFgOkB5cg89N1KdPmaTCNtVdN3mmcRx4g&s" style="width: 40%; border-radius: 8px;" alt="Remote I/O Module" />
            </div>
            <p style="font-size: 18px; margin: 2px 0;">
                Remote I/O Modules improve system efficiency by minimizing cable requirements and allowing remote monitoring 
                and control of industrial processes. They support multiple communication protocols, including <b>Modbus, 
                PROFIBUS, Ethernet/IP, and Profinet</b>, ensuring compatibility with a wide range of industrial networks.
            </p>
            <div style="display: flex; justify-content: center; margin: 2px 0;">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYBXA9LkqErxbiQ1HAXqdZNSs6OYFo36-Aew&s" style="width: 40%; border-radius: 8px;" alt="Remote I/O Module" />
            </div>
            <p style="font-size: 18px; margin: 2px 0;">
                These modules are ideal for applications where centralized control is not feasible, such as <b>manufacturing plants</b>, 
            ...
            <p style="font-size: 18px; margin: 2px 0;">
                ...
                reliable and cost-effective modules tailored to your automation needs.
            </p>
        `
    },
];
